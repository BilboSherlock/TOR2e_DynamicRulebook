...
description: Heroic Cultures of Eriador, Callings, Cultural Traits, Attributes, Virtues, and Character Creation.
iconName: UserCheck
tags: ["Adventurers", "Cultures", "Callings", "Bardings", "Dwarves", "Elves", "Hobbits", "Bree", "Rangers"]
---
...
The section is concluded by a rough indication of the starting resources available to the average adventurer belonging to that culture, in the form of a [[Characteristics/Standard of Living]](Standard of Living). The game ranks the economic status of a folk in six tiers: Poor, Frugal, Common, Prosperous, Rich and Very Rich.

## Attributes
There are three Attributes in _The One Ring_: **Strength**, **Heart**, and **Wits**. These scores describe an adventurer’s fundamental physical, emotional, and mental capabilities—the comparison between the three ratings provides a rough outline of an adventurer that is recognisable at a glance: Is your hero physically stronger, or more spiritually robust? Or are their wits their most distinctive quality?
...
| **RATING** | **SKILL** | **COMBAT PROFICIENCIES** |
| --- | --- | --- |
| — | Unskilled | Untrained |
| ◆ | Poor | Beginning |
| ◆◆ | Average | Average |
...
Every name in _The Lord of the Rings_ and _The Hobbit_ has been carefully crafted, building upon solid linguistic foundations, and represents a precise cultural influence. The native language of every character-type presented in this chapter has been identified, and a list of personal names appropriate to each Culture is provided.
...
## Heroic Cultures List

[[Adventurers/Heroic Cultures]](Heroic Cultures)
...
Whatever it is that motivates the Player-heroes, it must be something that for them is worth the risk of crossing swords with the curved blades of Orcs. In _The One Ring_, this motivation is represented by an adventurer’s Calling.
...
*   **Favoured Skills.** Each Calling lists three Skills. When you select a Calling, you choose two Skills among those listed and mark them as _Favoured_ Skills.
...
A player wanting to go from **Lore** ◆ to ◆◆◆◆ **Lore** would spend a total of 10 points (2 to raise the Skill from ◆ to ◆◆, 3 to go from ◆◆ to ◆◆◆, and 5 to go from ◆◆◆ to ◆◆◆◆).
[/example]
...
\* Weapons used to make [[Adventuring Phases/Combat/#brawling-attack]](Brawling Attack).
...
At the start of the game, all players get to choose 1 Virtue and 1 Reward, selecting them among those listed in [[Valour & Wisdom/Valour & Wisdom]](Valour & Wisdom).

* * *
[red-box]
### Starting Rewards

1.  [[Valour & Wisdom/Rewards List/#close-fitting]](Close-fitting) (armour or helm) — Add +2 to the result of your **Protection** roll.
2.  [[Valour & Wisdom/Rewards List/#cunning-make]](Cunning Make) (armour, helm or shield) — Reduce your Load rating by 2.
3.  [[Valour & Wisdom/Rewards List/#fell]](Fell) (weapon) — Raise the Injury rating of a weapon by 2.
4.  [[The Loremaster/Superior Grievous]](Grievous) (weapon) — Raise the Damage rating of a weapon by 1.
5.  [[Valour & Wisdom/Rewards List/#keen]](Keen) (weapon) — Attack rolls score a Piercing Blow on a 9+.
6.  [[Valour & Wisdom/Rewards List/#reinforced]](Reinforced) (shield) — Raise a shield’s Parry bonus by +1.

### Starting Virtues

1. [[Valour & Wisdom/Virtues List/#confidence]](Confidence) - Raise your Hope by 2.
2. [[Valour & Wisdom/Virtues List/#dour-handed]](Dour-handed) - Add +1 to damage on a Heavy Blow, and +1 to Feat Die on a Pierce.
3. [[Valour & Wisdom/Virtues List/#hardiness]](Hardiness) - Raise your Endurance by 2.
4. [[Valour & Wisdom/Virtues List/#mastery]](Mastery) - Choose two Skills and make them *Favoured*.
5. [[Valour & Wisdom/Virtues List/#nimbleness]](Nimbleness) - Raise your Parry rating by 1.
6. [[Valour & Wisdom/Virtues List/#prowess]](Prowess) - Reduce one Attribute TN by 1.
...
| Gilraen, daughter of Dírhael | Champion, Warden | 0 | Resolve Journey Events within the old realm of Arnor as if in a Border Land. Choose the Meet Patron undertaking to receive a rumour. | Fight the Enemy, defend the weak. |
...
[key-box]
During the Adventuring Phase, Player-heroes can spend points of Fellowship to recover points of Hope when resting (see [[Characteristics/Endurance/#resting]](Resting)).
[/key-box]

Additionally, Fellowship can be spent to trigger special effects tied to the Company’s Patron (see [[The World/Who?/#patrons]](Patrons)).
...
Players are free to indicate any other Player-hero as their choice, even one that has already been chosen by someone else. The bond doesn’t have to be mutual: a hero who has been chosen by another hero as a Fellowship Focus is free to choose any other character as their own. In game terms, Player-heroes provide a greater advantage when they help their Fellowship focus:
...
[key-box]
Player-heroes gain 1 Shadow point whenever their Fellowship Focus is Wounded, suffers a bout of madness, or is otherwise seriously harmed (this Shadow gain cannot be prevented with a Shadow Test — see page ).
[/key-box]
...
* * *
[red-box]
### Session Length and Advancement Rate
