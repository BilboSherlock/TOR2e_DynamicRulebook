...
The section is concluded by a rough indication of the starting resources available to the average adventurer belonging to that culture, in the form of a [[Standard of Living]]. The game ranks the economic status of a folk in six tiers: Poor, Frugal, Common, Prosperous, Rich and Very Rich.
...
At the start of the game, all players get to choose 1 Virtue and 1 Reward, selecting them among those listed in [[Valour & Wisdom]].
...
2. [[Dour-handed]] - Add +1 to damage on a Heavy Blow, and +1 to Feat Die on a Pierce.
...
[key-box]
During the Adventuring Phase, Player-heroes can spend points of Fellowship to recover points of Hope when resting (see [[Resting]]).
[/key-box]

Additionally, Fellowship can be spent to trigger special effects tied to the Company’s Patron (see [[Patrons]]).
...
[key-box]
To designate an heir, players must choose the Raise an Heir undertaking during any Yule Fellowship Phase (see [[Yule]]). Then, they must spend up to 5 Treasure points and an equal number of Adventure points to form the heir’s Previous Experience reserve: for each Adventure point spent, raise the reserve by 1.
[/key-box]
